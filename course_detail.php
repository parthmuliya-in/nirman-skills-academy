...
<head>
    ...
    <style>
        ...
        .faq-contact-banner-2 {
            background: linear-gradient(135deg, #f33406, #ed944f);
            color: #fff;
            padding: 35px 25px;
            border-radius: 16px;
            text-align: center;
        ...
        .faq-contact-banner-2:hover {
            transform: translateY(-5px);
            box-shadow: 0 15px 40px rgba(0, 0, 0, 0.3);
        }

        .faq-contact-banner-2 h3 {
            font-size: 24px;
            margin-bottom: 10px;
            font-weight: 700;
        }

        .faq-contact-banner-2 p {
            font-size: 16px;
            margin-bottom: 20px;
        }

        .faq-contact-banner-2 .banner-btn {
            background: #fff;
            color: #ff6a42;
            font-weight: 700;
            padding: 12px 30px;
            ...
            box-shadow: 0 5px 15px rgba(255, 106, 66, 0.4);
            transition: all 0.3s ease;
        }

        .faq-contact-banner-2 .banner-btn:hover {
            background: #ffe6d9;
            color: #ff4d00;
            box-shadow: 0 8px 25px rgba(255, 106, 66, 0.6);
...
<body>
    ...
    <main>
        <section class="course-section">
            <div class="video-container">
                <div class="bg-video">
                    <img src="<?php echo $banner_path; ?>" alt="<?php echo $banner_path; ?>" class="bg-video">
                </div>
                <div class="glass-box">
    ...
    <section class="faq-section">
        <div class="faq-container">
            ...
            <?php endwhile; ?>
            <!-- <a href="contact.php" class="faq-question">Got Questions? We’ve Got Answers!</a> -->

        </div>
    </section>

    <section class="faq-contact-banner-2">
        <div class="banner-content">
            <h3>Still Unsure About Anything?</h3>
            <p>Reach out to our team and get all your questions answered quickly!</p>
            <a href="contact.php" class="banner-btn">Contact Us Now</a>
        </div>
    </section>
