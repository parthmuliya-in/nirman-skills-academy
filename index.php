...
// Duplicate courses if fewer than 6 for looping effect
$original_count = count($courses);
if ($original_count > 0 && $original_count < 6) {
    $duplications_needed = ceil(6 / $original_count) - 1;
    for ($i = 0; $i < $duplications_needed; $i++) {
        $courses = array_merge($courses, $courses);
    }
    // Trim to exactly 6 or more if needed, but keep at least 6
    $courses = array_slice($courses, 0, max(6, count($courses)));
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
                    ...
                    <?php if (!empty($courses)): ?>
                        <?php foreach ($courses as $course): ?>
                            <div class="c1 course-page">
                                <div class="cm">
                                    <img src="admin/<?php echo $course['thumbnail']; ?>"
    ...
    <div class="Course-CHOOSE ">
        ...
        <div class="Course-CHOOSE-flex ">
            ...
            <div class="Course-CHOOSE-c1">
                ...
                <br>
                <p>Achieve certifications designed to enhance your professional profile.
            </div>
            <div class="Course-CHOOSE-c1">
    ...
    <div class="students">
        ...
        <div class="student-flex">
            <div class="students-c1">
                ...
                <ul>
                    <li>
                        The Nirman Skills Academy is a modern, career-focused training institute in Ahmedabad,dedicated
                        to
    ...
    <script>
        ...
        // Auto-sliding carousel with loop
        const carousel = document.querySelector('.courseflex');
        if (carousel) {
            const slideWidth = 320; // Card width + margin (300px + 20px)
            ...
            function slideNext() {
                ...
                if (Math.abs(currentPosition) >= carousel.scrollWidth) {
                    currentPosition = 0; // Reset for loop
                }
